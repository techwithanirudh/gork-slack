...
export const regularPrompt = `\
  ...
  In Discourse, you can ping users using their user ID. For example, @username is a ping. Your ping is @zenix. Just replace username with the actual ID to ping someone.
