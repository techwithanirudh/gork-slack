 ...
 */
export const sendDownloadBackupEmail = <ThrowOnError extends boolean = false>(options: Options<SendDownloadBackupEmailData, ThrowOnError>) => {
 ...
 * Delete badge
 */
export const deleteBadge = <ThrowOnError extends boolean = false>(options: Options<DeleteBadgeData, ThrowOnError>) => {
 ...
 * Remove a topic
 */
export const removeTopic = <ThrowOnError extends boolean = false>(options: Options<RemoveTopicData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<unknown, unknown, ThrowOnError>({
        url: '/t/{id}.json',
        ...options
    });
 ...
 * Bookmark topic
 */
export const bookmarkTopic = <ThrowOnError extends boolean = false>(options: Options<BookmarkTopicData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<unknown, unknown, ThrowOnError>({
 ...
 */
export const getTopicByExternalId = <ThrowOnError extends boolean = false>(options: Options<GetTopicByExternalIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<unknown, unknown, ThrowOnError>({
 ...
 * Update email
 */
export const updateEmail = <ThrowOnError extends boolean = false>(options: Options<UpdateEmailData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<unknown, unknown, ThrowOnError>({
 ...
 * Update username
 */
export const updateUsername = <ThrowOnError extends boolean = false>(options: Options<UpdateUsernameData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<unknown, unknown, ThrowOnError>({
...
export const postMessage = <ThrowOnError extends boolean = false>(options: Options<PostMessageData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostMessageResponse, unknown, ThrowOnError>({
        responseValidator: async (data) => {
            return await zPostMessageResponse.parseAsync(data);
        },
        url: '/chat/{channel_id}',
        ...options,
        headers: {
 ...
 */
export const getChatChannel = <ThrowOnError extends boolean = false>(options: Options<GetChatChannelData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<GetChatChannelResponse, unknown, ThrowOnError>({
        responseValidator: async (data) => {
            return await zGetChatChannelResponse.parseAsync(data);
        },
...
export const getUserInfo = <ThrowOnError extends boolean = false>(options: Options<GetUserInfoData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetUserInfoResponse, unknown, ThrowOnError>({
        responseValidator: async (data) => {
            return await zGetUserInfoResponse.parseAsync(data);
        },
